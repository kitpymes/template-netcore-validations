    ...
    public static class FakeTypes
    {
        public class ValueTypes
        {
            public class SimpleTypes
            {
                ...
                #endregion Entero sin signo

                #region Caracteres Unicode
                ...
                #endregion Caracteres Unicode

                #region Punto flotante binario IEEE
                ...
                #endregion Punto flotante binario IEEE

                #region Punto flotante decimal de alta precisión
                ...
                #endregion Punto flotante decimal de alta precisión
            ...
            {
                public enum ExampleEnumeration { a, e, i, o, u };
            }
        ...
        public class ReferenceTypes
        {
            public class ClassTypes
            {
                ...
                public static FakeObject? Class_Null { get; } = null;
                public static FakeObject? Class_Default { get; } = default; // null
                public static FakeObject Class_Empty { get; } = new FakeObject();
                public static FakeObject Class_New()
                => new FakeObject
                {
                    ConfirmPassword = String_New(),
                    Email = String_New(),
                    Subdomain = String_New(),
