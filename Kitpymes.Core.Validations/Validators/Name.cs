    ...
    */
    ...
    public partial class ValidatorRuleOptions
    {
        ...
        public ValidatorRuleOptions IsName(string? overrideRureFieldName = null)
        {
            ...
            {
                ValidatorRule.Add(()
                    => Messages.Name(_value is string ? _value?.ToString() : null, GetRuleFieldName(overrideRureFieldName)));
            }
        ...
        private bool IsNameHasErrors() => !(_value is string) || Shared.Util.Check.IsName(_value?.ToString()).HasErrors;
    }
}