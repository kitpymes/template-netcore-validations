// -----------------------------------------------------------------------
// <copyright file="Directory.cs" company="Kitpymes">
...
namespace Kitpymes.Core.Validations
{
    ...
    */
    ...
    public partial class ValidatorRuleOptions
    {
        ...
        {
            if (IsDirectoryHasErrors())
            {
                ValidatorRule.Add(()
                    => Messages.Directory(_value is string ? _value?.ToString() : null, GetRuleFieldName(overrideRureFieldName)));
            }
        ...
        private bool IsDirectoryHasErrors() => !(_value is string) || Shared.Util.Check.IsDirectory(_value?.ToString()).HasErrors;
    }
}
