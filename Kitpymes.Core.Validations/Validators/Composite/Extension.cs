    ...
    */
    ...
    public partial class ValidatorRuleOptions
    {
        ...
        public ValidatorRuleOptions IsExtension(string? overrideRureFieldName = null)
        {
            ...
            {
                ValidatorRule.Add(()
                     => Messages.Extension(_value is string ? _value?.ToString() : null, GetRuleFieldName(overrideRureFieldName)));
            }
        ...
        private bool IsExtensionHasErrors() => !(_value is string) || Check.IsExtension(_value?.ToString()).HasErrors;
    }
}
