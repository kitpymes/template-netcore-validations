    ...
    */
    ...
    public partial class ValidatorRuleOptions
    {
        ...
        public ValidatorRuleOptions IsEmail(string? overrideRureFieldName = null)
        {
            ...
            {
                ValidatorRule.Add(()
                    => Messages.Email(_value is string ? _value?.ToString() : null, GetRuleFieldName(overrideRureFieldName)));
            }
        ...
        private bool IsEmailHasErrors() => !(_value is string) || Shared.Util.Check.IsEmail(_value?.ToString()).HasErrors;
    }
}
