...
namespace Kitpymes.Core.Validations
{
    ...
    */
    ...
    public partial class ValidatorRuleOptions
    {
        ...
        {
            if (IsMaxHasErrors(max))
            {
                ValidatorRule.Add(() => Messages.Max(max, GetRuleFieldName(overrideRureFieldName)));
            }
        ...
        private bool IsMaxHasErrors(long max) => Check.IsMax(max, _value).HasErrors;
    }
}
