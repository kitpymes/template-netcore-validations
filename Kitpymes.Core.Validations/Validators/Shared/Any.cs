    ...
    */
    ...
    public partial class ValidatorRuleOptions
    {
        ...
        public ValidatorRuleOptions IsAny(string? overrideRureFieldName = null)
        {
            if (IsAnyHasErrors())
            {
                ValidatorRule.Add(() => Messages.Any(GetRuleFieldName(overrideRureFieldName)));
            }
        ...
        private bool IsAnyHasErrors() => !(_value is IEnumerable) || Check.IsAny(_value as IEnumerable).HasErrors;
    }
}
